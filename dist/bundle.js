...
var _peoples = __webpack_require__(331);
...
var _marked = /*#__PURE__*/regeneratorRuntime.mark(a); //Using Babel:


var test_babel = "THIS IS A TEST";
...
console.log("carlos"), _jquery2.default.each(_peoples2.default, function (key, value) {
  (0, _jquery2.default)('body').append('<h1>' + _peoples2.default[key].name + '</h1>');
});
...
var peoples = [{
  name: "Thiago Silva Polo",
  nickname: "yago10"
}, {
  name: "Vania Silva",
  nickname: "princesa10"
}, {
  name: "Catherine Alfaro",
  nickname: "princesa10"
}];
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!./another.css", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!./another.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
